            ...
            <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
                ...
                <div className="grid grid-cols-1 items-center gap-8 sm:gap-20 lg:grid-cols-2">
                    ...
                    <div className="max-w-[720px]">
                        ...
                        <p className="mb-6 max-w-[528px] text-xl md:mb-10">Sumérgete en el mundo de la tecnología con nuestro fabricante argentino de robots líder en Latinoamérica. Descubre la excelencia, la precisión y la innovación que solo nosotros ofrecemos. Con soluciones a la medida de tus necesidades, estamos aquí para potenciar el futuro de tu empresa. ¡Conviértete en pionero de la automatización con nosotros!</p>
