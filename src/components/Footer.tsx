            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between py-7">
                    ...
                    <div className="flex items-center justify-center gap-4 lg:justify-center flex-wrap">
                        {/* ICONO INSTAGRAM */}
                        <Link href="https://www.instagram.com/" target="blank" className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden shadow-md group transition-all duration-500" >
...
/>
                        ...
                        {/* ICONO DE TWITER X */}
                        <Link href="https://x.com/" target="blank" className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden shadow-md group transition-all duration-300">
                        ...
                        {/* ICONO DE WHATSAPP */}
                        <Link href="https://wa.me/+5491132027035/" className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full shadow-md group transition-all duration-300">
                        ...
                        {/* ICONO DE LinkedIn */}
                        <Link href="https://www.linkedin.com/" target="blank" className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full shadow-md group transition-all duration-300">
                        ...
                        {/* ICONO DE CORREO */}
                        <Link href="mailto:info@zwol-robotic.com.ar" target="blank" className="w-10 h-10 flex relative overflow-hidden items-center justify-center rounded-full shadow-md bg-opacity-0 group transition-all duration-500">
                            <svg className="fill-gray-900 relative z-10 transition-all duration-300 group-hover:fill-white"
                                ...
                                <path d="M4.00654 40.1236H12.4893V19.5227L0.371094 10.4341V36.4881C0.371094 38.4997 2.00099 40.1236 4.00654 40.1236Z"/>
                                <path d="M41.5732 40.1236H50.056C52.0676 40.1236 53.6914 38.4937 53.6914 36.4881V10.4341L41.5732 19.5227"/>
                                <path d="M41.5732 3.7693V19.5229L53.6914 10.4343V5.58702C53.6914 1.09118 48.5594 -1.47181 44.9663 1.22448"/>
                                <path d="M12.4893 19.5227V3.76904L27.0311 14.6754L41.5729 3.76904V19.5227L27.0311 30.429"/>
                                <path d="M0.371094 5.58702V10.4343L12.4893 19.5229V3.7693L9.09617 1.22448C5.49708 -1.47181 0.371094 1.09118 0.371094 5.58702Z"/>
                            </svg>
