...
const Footer = () => {
    return (
        <footer className="w-full bg-gradient-to-t from-zwol-1 to-white to-60%">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between py-7">
                    ...
                    <div className="flex items-center justify-center gap-4  lg:justify-center flex-wrap">
                        {/* ICONO INSTAGRAM */}
                        <button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden shadow-md group transition-all duration-500">
                        ...
                        {/* ICONO DE TWITER X */}
                        <button className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden shadow-md group transition-all duration-300">
                        ...
                        {/* ICONO DE WHATSAPP */}
                        <button className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full shadow-md group transition-all duration-300">
                        ...
                        {/* ICONO DE CORREO */}
                        <button className="w-10 h-10 flex relative overflow-hidden items-center justify-center rounded-full shadow-md bg-opacity-0 group transition-all duration-500">
