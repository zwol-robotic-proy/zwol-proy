...
export function Modal({ children }: { children: React.ReactNode }) {
  ...
  return createPortal(
    <div className={`select-none`} >
      ...
      <dialog ref={dialogRef} className="min-w-80 min-h-80 lg:min-w-[500px] lg:min-h-[500px] border-none rounded-xl flex justify-center items-center size-12 font-medium nth-1:object-contain">
        {children}
        <div className='w-full h-10 bottom-0 flex items-center justify-center absolute hover:bg-zwol-1/50 hover:text-white'>
